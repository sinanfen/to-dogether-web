...
export default function DemoPage() {
  ...
  const getAssignedColor = (assignedTo: string) => {
    switch (assignedTo) {
      ...
      case 'both': return 'text-orange-600 bg-orange-50'
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                {todos.map((todo) => (
                  <div
                    key={todo.id}
                    className={`flex items-center space-x-3 p-4 rounded-xl border transition-all duration-200 ${todo.completed
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm font-medium transition-all duration-200 ${todo.completed ? 'text-gray-500 line-through' : 'text-gray-900'
                        }`}>
                        {todo.text}
                      </p>
                    </div>
